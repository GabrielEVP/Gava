...
class ClientRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'tax_rate.numeric' => 'La tasa de impuestos debe ser un número.',
            'tax_rate.min' => 'La tasa de impuestos no puede ser menor que 0.',
            'tax_rate.max' => 'La tasa de impuestos no puede ser mayor que 100.',
